    ...
    <>
      <section className='about-main flex mt-12'>
          ...
          <div className='about'>
            ...
            <br/>
            <div>
            When I was 15, I managed to access databases through tools that automatically detect SQL injection (Havij, SQLI Dumper), which gave me a keen interest in cybersecurity and software.          </div>
            <br/>
            <div>
            ...
            <div className='social-links mt-5 d-flex align-items-center gap-4'>
              <div className="social-first">
                <Link to="https://app.hackthebox.com/users/1070265" target='_blank'>
                  <SiHackthebox />
                  Hackthebox
                </Link>
